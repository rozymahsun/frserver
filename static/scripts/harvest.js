...
(function() {
  var ERROR_THRESHOLD, MAX_DISTANCE, canvas, ctx, keepPredicting, goTrain, onError, onPredictClose, onSuccess, onTrainClose, predict, setupWS, showFace, train, attend, update, updateProgressBar, video,
    _this = this;
...
//    ctx.drawImage(video, 0, 0, 320, 240);
 ...
 // console.log(button.length);
  ...
  attend = function() {
    ...
    //saveAbsensi = function(Attendance){
    return $.post('/absen',{
        id: data.face.id
      }).success(function() {
      console.log("done Absensi");
